 ...
 * unions below are modelled on deviceSMD.h's SMDControlRegister/SMDStatusRegister.
 *
 ...
 * bit-field union like deviceSMD.h's SMDStatusRegister; all fields uint16_t.
 *
