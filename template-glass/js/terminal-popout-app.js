...
(function () {
    ...
    var fontSelect = document.getElementById('popout-font-select');
    var colorSelect = document.getElementById('popout-color-select');
    // Build font select options from canonical list
    fontSelect.innerHTML = '';
    window.terminalFontOptions.forEach(function (o) {
    ...
    window.terminalColorOptions.forEach(function (o) {
        var opt = document.createElement('option');
        opt.value = o.val;
        opt.textContent = o.label;
        if (o.val === colorTheme)
